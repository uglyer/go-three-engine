...
func NewColor4(name string, alpha ...float64) *Color4 {
...
// and an optional alpha channel value.
func Color4Name(name string, alpha ...float64) Color4 {
...
func (c *Color4) Set(r, g, b, a float64) *Color4 {
...
func (c *Color4) SetHex(value uint) *Color4 {
	...
	c.R = float64((value >> 16 & 255)) / 255
	c.G = float64((value >> 8 & 255)) / 255
	c.B = float64((value & 255)) / 255
	return c
}
...
// Returns pointer to this updated color
func (c *Color4) MultiplyScalar(v float64) *Color4 {
...
func (c *Color4) FromColor(other *Color, alpha float64) {
