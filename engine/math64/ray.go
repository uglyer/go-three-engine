...
func (ray *Ray) Copy(other *Ray) *Ray {
	...
	ray.PointRadius = other.PointRadius
	return ray
}
...
func (ray *Ray) At(t float64, optionalTarget *Vector3) *Vector3 {
...
func (ray *Ray) Recast(t float64) *Ray {
...
func (ray *Ray) DistanceToPoint(point *Vector3) float64 {

	return Sqrt(ray.DistanceSqToPoint(point))
}

// IntersectsSphere 是否与球相交
...
func (ray *Ray) DistanceSqToPoint(point *Vector3) float64 {
...
func (ray *Ray) DistanceSqToSegment(v0, v1, optionalPointOnRay, optionalPointOnSegment *Vector3) float64 {
...
func (ray *Ray) DistanceToPlane(plane *Plane) float64 {
...
func (ray *Ray) Clone() *Ray {
	...
	return NewRay(nil, nil).Copy(ray)
}
